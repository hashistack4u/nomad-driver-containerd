...
| **containerd_runtime** | string | false | Linux: `io.containerd.runc.v2` , Windows: `io.containerd.runhcs.v1` | Runtime for containerd e.g. `io.containerd.runc.v1` or `io.containerd.runc.v2`. |
